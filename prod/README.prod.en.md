...
- The sample applications explicitly set `service.namespace=apps-prod` and `service.version=1.0.1`; production workloads should replace `service.version` with the real release or image version.
